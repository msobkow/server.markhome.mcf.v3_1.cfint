...
public interface ICFIntSubProjectTableObj
{
	 ...
	 */
	ICFIntSubProjectObj readSubProject( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFIntSubProjectObj readCachedSubProject( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeSubProject( ICFIntSubProjectObj obj );

	void deepDisposeSubProject( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFIntSubProjectObj lockSubProject( $implCommaIJavaOptAtomType$ pkey );
