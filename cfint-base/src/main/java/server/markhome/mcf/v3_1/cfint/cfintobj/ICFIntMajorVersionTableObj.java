...
public interface ICFIntMajorVersionTableObj
{
	 ...
	 */
	ICFIntMajorVersionObj readMajorVersion( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFIntMajorVersionObj readCachedMajorVersion( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeMajorVersion( ICFIntMajorVersionObj obj );

	void deepDisposeMajorVersion( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFIntMajorVersionObj lockMajorVersion( $implCommaIJavaOptAtomType$ pkey );
