...
public class CFIntJpaMinorVersionService {
	...
	public CFIntJpaMinorVersion create(CFIntJpaMinorVersion data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31MinorVersionRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFIntJpaMinorVersion)(cfint31MinorVersionRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFIntJpaMinorVersion update(CFIntJpaMinorVersion data) {
		...
		CFIntJpaMinorVersion existing = cfint31MinorVersionRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
