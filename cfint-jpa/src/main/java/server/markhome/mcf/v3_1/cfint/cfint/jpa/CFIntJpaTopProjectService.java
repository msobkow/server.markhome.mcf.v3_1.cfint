...
public class CFIntJpaTopProjectService {
	...
	public CFIntJpaTopProject create(CFIntJpaTopProject data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31TopProjectRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFIntJpaTopProject)(cfint31TopProjectRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFIntJpaTopProject update(CFIntJpaTopProject data) {
		...
		CFIntJpaTopProject existing = cfint31TopProjectRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
