...
public class CFIntJpaSubProjectService {
	...
	public CFIntJpaSubProject create(CFIntJpaSubProject data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31SubProjectRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFIntJpaSubProject)(cfint31SubProjectRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFIntJpaSubProject update(CFIntJpaSubProject data) {
		...
		CFIntJpaSubProject existing = cfint31SubProjectRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
