...
public class CFIntJpaMajorVersionService {
	...
	public CFIntJpaMajorVersion create(CFIntJpaMajorVersion data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31MajorVersionRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFIntJpaMajorVersion)(cfint31MajorVersionRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFIntJpaMajorVersion update(CFIntJpaMajorVersion data) {
		...
		CFIntJpaMajorVersion existing = cfint31MajorVersionRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
