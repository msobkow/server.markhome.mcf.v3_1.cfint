...
public class CFIntJpaURLProtocolService {
	...
	public CFIntJpaURLProtocol create(CFIntJpaURLProtocol data) {
		...
		try {
			if(data.getPKey() != null && cfint31URLProtocolRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFIntJpaURLProtocol)(cfint31URLProtocolRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFIntJpaURLProtocol update(CFIntJpaURLProtocol data) {
		...
		CFIntJpaURLProtocol existing = cfint31URLProtocolRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
