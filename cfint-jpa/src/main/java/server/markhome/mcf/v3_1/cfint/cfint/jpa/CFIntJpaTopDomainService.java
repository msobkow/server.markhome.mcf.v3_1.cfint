...
public class CFIntJpaTopDomainService {
	...
	public CFIntJpaTopDomain create(CFIntJpaTopDomain data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31TopDomainRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFIntJpaTopDomain)(cfint31TopDomainRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFIntJpaTopDomain update(CFIntJpaTopDomain data) {
		...
		CFIntJpaTopDomain existing = cfint31TopDomainRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
