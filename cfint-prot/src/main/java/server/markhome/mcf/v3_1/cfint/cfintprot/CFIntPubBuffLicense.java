// Description: Java 17 implJustPubementation of a License buffer
...
public class CFIntPubBuffLicense
	implements ICFIntPubLicense, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFIntPubLicense.CLASS_CODE );
	}
	...
	@Override
	public ICFIntPubTopDomain getRequiredContainerTopDomain(ICFLibKeyHash256 argTopDomainId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerTopDomain", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerTopDomain", 0, "ICFIntPubSchema.getBackingCFInt().getTableTopDomain()");
		}
	...
	public void setRequiredContainerTopDomain(ICFLibKeyHash256 argTopDomainId) {
		...
		if (found == null) {
			...
			super.setRequiredContainerTopDomain(argTopDomainId);
		requiredTopDomainId = argTopDomainId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerTopDomain-args", "found", found, "ICFIntPubTopDomainICFIntPubTopDomain");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubLicenseHPKey ) {
			ICFIntPubLicenseHPKey rhs = (ICFIntPubLicenseHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setLicense( ICFIntPubLicense src ) {
		...
		setJustPubRequiredContainerTopDomain(src.getRequiredContainerTopDomain());
		...
		setJustPubOptionalEmbeddedText(src.getOptionalEmbeddedText());
		setJustPubOptionalFullText(src.getOptionalFullText());
	}
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredTopDomainId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" ) + ( ( getOptionalEmbeddedText() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalEmbeddedText() ) + "\"" ) + ( ( getOptionalFullText() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalFullText() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffLicense" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
