// Description: Java 17 implJustPubementation of a TopDomain buffer
...
public class CFIntPubBuffTopDomain
	implements ICFIntPubTopDomain, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntPubTopProject> getOptionalComponentsTopProject(ICFLibKeyHash256 argId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopProject", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTopProjectTable targetTable = targetBackingCFInt.getTableTopProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopProject", 0, "ICFIntPubSchema.getBackingCFInt().getTableTopProject()");
		}
	...
	@Override
	public List<ICFIntPubLicense> getOptionalComponentsLicense(ICFLibKeyHash256 argId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsLicense", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubLicenseTable targetTable = targetBackingCFInt.getTableLicense();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsLicense", 0, "ICFIntPubSchema.getBackingCFInt().getTableLicense()");
		}
	...
	public int getClassCode() {
		return( ICFIntPubTopDomain.CLASS_CODE );
	}
	...
	@Override
	public ICFIntPubTld getRequiredContainerParentTld(ICFLibKeyHash256 argTldId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTld", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTldTable targetTable = targetBackingCFInt.getTableTld();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTld", 0, "ICFIntPubSchema.getBackingCFInt().getTableTld()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredTldId()));
	}
	...
	public void setRequiredContainerParentTld(ICFLibKeyHash256 argTldId) {
		...
		else if (found instanceof ICFIntPubTld) || (found instanceof ICFIntPubTld)) {
			super.setRequiredContainerParentTld(argTldId);
		requiredTldId = argTldId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentTld-args", "found", found, "ICFIntPubTldICFIntPubTld");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubTopDomainHPKey ) {
			ICFIntPubTopDomainHPKey rhs = (ICFIntPubTopDomainHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setTopDomain( ICFIntPubTopDomain src ) {
		...
		setJustPubRequiredContainerParentTld(src.getRequiredContainerParentTld());
		setJustPubRequiredTenantId(src.getRequiredTenantId());
		setJustPubRequiredTldId(src.getRequiredTldId());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredTldId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffTopDomain" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
