// Description: Java 17 implJustPubementation of a Tld buffer
...
public class CFIntPubBuffTld
	implements ICFIntPubTld, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntPubTopDomain> getOptionalComponentsTopDomain(ICFLibKeyHash256 argId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopDomain", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopDomain", 0, "ICFIntPubSchema.getBackingCFInt().getTableTopDomain()");
		}
	...
	public int getClassCode() {
		return( ICFIntPubTld.CLASS_CODE );
	}

	@Override
	public ICFSecPubTenant getRequiredContainerTenant(ICFLibKeyHash256 argTenantId) {
	...
	public void setRequiredContainerTenant(ICFLibKeyHash256 argTenantId) {
		...
		if (found == null) {
			...
			super.setRequiredContainerTenant(argTenantId);
		requiredTenantId = argTenantId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerTenant-args", "found", found, "ICFSecPubTenantICFSecPubTenant");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubTldHPKey ) {
			ICFIntPubTldHPKey rhs = (ICFIntPubTldHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setTld( ICFIntPubTld src ) {
		...
		setJustPubRequiredContainerTenant(src.getRequiredContainerTenant());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffTld" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
