// Description: Java 17 implJustPubementation of a MinorVersion buffer
...
public class CFIntPubBuffMinorVersion
	implements ICFIntPubMinorVersion, Comparable<Object>, Serializable
{
	...
	public CFIntPubBuffMinorVersion() {
	...
	public int getClassCode() {
		return( ICFIntPubMinorVersion.CLASS_CODE );
	}
	...
	@Override
	public ICFIntPubMajorVersion getRequiredContainerParentMajVer(ICFLibKeyHash256 argMajorVersionId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentMajVer", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubMajorVersionTable targetTable = targetBackingCFInt.getTableMajorVersion();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentMajVer", 0, "ICFIntPubSchema.getBackingCFInt().getTableMajorVersion()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredMajorVersionId()));
	}
	...
	public void setRequiredContainerParentMajVer(ICFLibKeyHash256 argMajorVersionId) {
		...
		else if (found instanceof ICFIntPubMajorVersion) || (found instanceof ICFIntPubMajorVersion)) {
			super.setRequiredContainerParentMajVer(argMajorVersionId);
		requiredMajorVersionId = argMajorVersionId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentMajVer-args", "found", found, "ICFIntPubMajorVersionICFIntPubMajorVersion");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubMinorVersionHPKey ) {
			ICFIntPubMinorVersionHPKey rhs = (ICFIntPubMinorVersionHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setMinorVersion( ICFIntPubMinorVersion src ) {
		...
		setJustPubRequiredContainerParentMajVer(src.getRequiredContainerParentMajVer());
		setJustPubRequiredTenantId(src.getRequiredTenantId());
		setJustPubRequiredMajorVersionId(src.getRequiredMajorVersionId());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredMajorVersionId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffMinorVersion" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
