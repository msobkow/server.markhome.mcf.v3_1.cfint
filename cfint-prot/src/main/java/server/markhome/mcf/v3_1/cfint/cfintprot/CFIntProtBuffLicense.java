// Description: Java 17 implJustProtementation of a License buffer
	...
	implements ICFIntProtLicense, Comparable<Object>, Serializable
{
	...
	@Override
	public ICFIntProtTopDomain getRequiredContainerTopDomain(ICFLibKeyHash256 argTopDomainId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerTopDomain", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerTopDomain", 0, "ICFIntProtSchema.getBackingCFInt().getTableTopDomain()");
		}
	...
	public void setRequiredContainerTopDomain(ICFLibKeyHash256 argTopDomainId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerTopDomain-args", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
		...
		requiredTopDomainId = argTopDomainId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerTopDomain-args", "found", found, "ICFIntProtTopDomainICFIntProtTopDomainICFIntPubTopDomain");
		}
	}
