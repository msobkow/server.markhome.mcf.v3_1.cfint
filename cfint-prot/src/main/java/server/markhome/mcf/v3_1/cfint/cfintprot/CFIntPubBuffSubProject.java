// Description: Java 17 implJustPubementation of a SubProject buffer
...
public class CFIntPubBuffSubProject
	implements ICFIntPubSubProject, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntPubMajorVersion> getOptionalComponentsMajorVer(ICFLibKeyHash256 argId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMajorVer", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubMajorVersionTable targetTable = targetBackingCFInt.getTableMajorVersion();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMajorVer", 0, "ICFIntPubSchema.getBackingCFInt().getTableMajorVersion()");
		}
	...
	public int getClassCode() {
		return( ICFIntPubSubProject.CLASS_CODE );
	}
	...
	@Override
	public ICFIntPubTopProject getRequiredContainerParentTPrj(ICFLibKeyHash256 argTopProjectId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTPrj", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTopProjectTable targetTable = targetBackingCFInt.getTableTopProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTPrj", 0, "ICFIntPubSchema.getBackingCFInt().getTableTopProject()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredTopProjectId()));
	}
	...
	public void setRequiredContainerParentTPrj(ICFLibKeyHash256 argTopProjectId) {
		...
		else if (found instanceof ICFIntPubTopProject) || (found instanceof ICFIntPubTopProject)) {
			super.setRequiredContainerParentTPrj(argTopProjectId);
		requiredTopProjectId = argTopProjectId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentTPrj-args", "found", found, "ICFIntPubTopProjectICFIntPubTopProject");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubSubProjectHPKey ) {
			ICFIntPubSubProjectHPKey rhs = (ICFIntPubSubProjectHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setSubProject( ICFIntPubSubProject src ) {
		...
		setJustPubRequiredContainerParentTPrj(src.getRequiredContainerParentTPrj());
		setJustPubRequiredTenantId(src.getRequiredTenantId());
		setJustPubRequiredTopProjectId(src.getRequiredTopProjectId());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredTopProjectId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffSubProject" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
