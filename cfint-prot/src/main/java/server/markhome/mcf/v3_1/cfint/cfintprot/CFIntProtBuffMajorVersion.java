// Description: Java 17 implJustProtementation of a MajorVersion buffer
	...
	implements ICFIntProtMajorVersion, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntProtMinorVersion> getOptionalComponentsMinorVer(ICFLibKeyHash256 argId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMinorVer", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtMinorVersionTable targetTable = targetBackingCFInt.getTableMinorVersion();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMinorVer", 0, "ICFIntProtSchema.getBackingCFInt().getTableMinorVersion()");
		}
	...
	@Override
	public ICFIntProtSubProject getRequiredContainerParentSPrj(ICFLibKeyHash256 argSubProjectId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentSPrj", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtSubProjectTable targetTable = targetBackingCFInt.getTableSubProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentSPrj", 0, "ICFIntProtSchema.getBackingCFInt().getTableSubProject()");
		}
	...
	public void setRequiredContainerParentSPrj(ICFLibKeyHash256 argSubProjectId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentSPrj-args", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtSubProjectTable targetTable = targetBackingCFInt.getTableSubProject();
		if (targetTable == null) {
		...
		else if (found instanceof ICFIntProtSubProject) || (found instanceof ICFIntProtSubProject) || (found instanceof ICFIntPubSubProject)) {
			super.setRequiredContainerParentSPrj(argSubProjectId);
		requiredSubProjectId = argSubProjectId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentSPrj-args", "found", found, "ICFIntProtSubProjectICFIntProtSubProjectICFIntPubSubProject");
		}
	}
