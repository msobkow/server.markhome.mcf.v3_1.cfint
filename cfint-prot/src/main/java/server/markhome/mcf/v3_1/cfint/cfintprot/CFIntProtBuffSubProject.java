// Description: Java 17 implJustProtementation of a SubProject buffer
	...
	implements ICFIntProtSubProject, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntProtMajorVersion> getOptionalComponentsMajorVer(ICFLibKeyHash256 argId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMajorVer", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtMajorVersionTable targetTable = targetBackingCFInt.getTableMajorVersion();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMajorVer", 0, "ICFIntProtSchema.getBackingCFInt().getTableMajorVersion()");
		}
	...
	@Override
	public ICFIntProtTopProject getRequiredContainerParentTPrj(ICFLibKeyHash256 argTopProjectId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTPrj", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTopProjectTable targetTable = targetBackingCFInt.getTableTopProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTPrj", 0, "ICFIntProtSchema.getBackingCFInt().getTableTopProject()");
		}
	...
	public void setRequiredContainerParentTPrj(ICFLibKeyHash256 argTopProjectId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentTPrj-args", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTopProjectTable targetTable = targetBackingCFInt.getTableTopProject();
		if (targetTable == null) {
		...
		else if (found instanceof ICFIntProtTopProject) || (found instanceof ICFIntProtTopProject) || (found instanceof ICFIntPubTopProject)) {
			super.setRequiredContainerParentTPrj(argTopProjectId);
		requiredTopProjectId = argTopProjectId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentTPrj-args", "found", found, "ICFIntProtTopProjectICFIntProtTopProjectICFIntPubTopProject");
		}
	}
