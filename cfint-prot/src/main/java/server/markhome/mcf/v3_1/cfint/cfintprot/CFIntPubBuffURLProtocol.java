// Description: Java 17 implJustPubementation of a URLProtocol buffer
...
public class CFIntPubBuffURLProtocol
	implements ICFIntPubURLProtocol, Comparable<Object>, Serializable
{
	...
	public CFIntPubBuffURLProtocol() {
	...
	public int getClassCode() {
		return( ICFIntPubURLProtocol.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubURLProtocolHPKey ) {
			ICFIntPubURLProtocolHPKey rhs = (ICFIntPubURLProtocolHPKey)obj;
			if( getRequiredURLProtocolId() != rhs.getRequiredURLProtocolId() ) {
				return( false );
			}
			return( true );
	...
	public void set( ICFIntPubURLProtocol src ) {
		setJustPubURLProtocol( src );
	}

	@Override
	public void setURLProtocol( ICFIntPubURLProtocol src ) {
		setJustPubRequiredURLProtocolId(src.getRequiredURLProtocolId());
		...
		setJustPubRequiredIsSecure(src.getRequiredIsSecure());
	}
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + Integer.toString( getRequiredURLProtocolId() ) + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredDescription() ) + "\"" + (( getRequiredIsSecure() ) ? "\"true\"" : "\"false\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffURLProtocol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
