// Description: Java 17 implJustProtementation of a MinorVersion buffer
	...
	implements ICFIntProtMinorVersion, Comparable<Object>, Serializable
{
	...
	@Override
	public ICFIntProtMajorVersion getRequiredContainerParentMajVer(ICFLibKeyHash256 argMajorVersionId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentMajVer", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtMajorVersionTable targetTable = targetBackingCFInt.getTableMajorVersion();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentMajVer", 0, "ICFIntProtSchema.getBackingCFInt().getTableMajorVersion()");
		}
	...
	public void setRequiredContainerParentMajVer(ICFLibKeyHash256 argMajorVersionId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentMajVer-args", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtMajorVersionTable targetTable = targetBackingCFInt.getTableMajorVersion();
		if (targetTable == null) {
		...
		else if (found instanceof ICFIntProtMajorVersion) || (found instanceof ICFIntProtMajorVersion) || (found instanceof ICFIntPubMajorVersion)) {
			super.setRequiredContainerParentMajVer(argMajorVersionId);
		requiredMajorVersionId = argMajorVersionId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentMajVer-args", "found", found, "ICFIntProtMajorVersionICFIntProtMajorVersionICFIntPubMajorVersion");
		}
	}
