// Description: Java 17 implJustPubementation of a MajorVersion buffer
...
public class CFIntPubBuffMajorVersion
	implements ICFIntPubMajorVersion, Comparable<Object>, Serializable
{
	...
	public CFIntPubBuffMajorVersion() {
	...
	@Override
	public List<ICFIntPubMinorVersion> getOptionalComponentsMinorVer(ICFLibKeyHash256 argId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMinorVer", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubMinorVersionTable targetTable = targetBackingCFInt.getTableMinorVersion();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsMinorVer", 0, "ICFIntPubSchema.getBackingCFInt().getTableMinorVersion()");
		}
	...
	public int getClassCode() {
		return( ICFIntPubMajorVersion.CLASS_CODE );
	}
	...
	@Override
	public ICFIntPubSubProject getRequiredContainerParentSPrj(ICFLibKeyHash256 argSubProjectId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentSPrj", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubSubProjectTable targetTable = targetBackingCFInt.getTableSubProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentSPrj", 0, "ICFIntPubSchema.getBackingCFInt().getTableSubProject()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredSubProjectId()));
	}
	...
	public void setRequiredContainerParentSPrj(ICFLibKeyHash256 argSubProjectId) {
		...
		else if (found instanceof ICFIntPubSubProject) || (found instanceof ICFIntPubSubProject)) {
			super.setRequiredContainerParentSPrj(argSubProjectId);
		requiredSubProjectId = argSubProjectId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentSPrj-args", "found", found, "ICFIntPubSubProjectICFIntPubSubProject");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubMajorVersionHPKey ) {
			ICFIntPubMajorVersionHPKey rhs = (ICFIntPubMajorVersionHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setMajorVersion( ICFIntPubMajorVersion src ) {
		...
		setJustPubRequiredContainerParentSPrj(src.getRequiredContainerParentSPrj());
		setJustPubRequiredTenantId(src.getRequiredTenantId());
		setJustPubRequiredSubProjectId(src.getRequiredSubProjectId());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredSubProjectId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffMajorVersion" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
