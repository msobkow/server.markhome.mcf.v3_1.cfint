// Description: Java 17 implJustPubementation of a TopProject buffer
...
public class CFIntPubBuffTopProject
	implements ICFIntPubTopProject, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntPubSubProject> getOptionalComponentsSubProject(ICFLibKeyHash256 argId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsSubProject", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubSubProjectTable targetTable = targetBackingCFInt.getTableSubProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsSubProject", 0, "ICFIntPubSchema.getBackingCFInt().getTableSubProject()");
		}
	...
	public int getClassCode() {
		return( ICFIntPubTopProject.CLASS_CODE );
	}
	...
	@Override
	public ICFIntPubTopDomain getRequiredContainerParentSDom(ICFLibKeyHash256 argTopDomainId) {
		ICFIntPubSchema targetBackingCFInt = ICFIntPubSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentSDom", 0, "ICFIntPubSchema.getBackingCFInt()");
		}
		ICFIntPubTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentSDom", 0, "ICFIntPubSchema.getBackingCFInt().getTableTopDomain()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredTopDomainId()));
	}
	...
	public void setRequiredContainerParentSDom(ICFLibKeyHash256 argTopDomainId) {
		...
		else if (found instanceof ICFIntPubTopDomain) || (found instanceof ICFIntPubTopDomain)) {
			super.setRequiredContainerParentSDom(argTopDomainId);
		requiredTopDomainId = argTopDomainId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentSDom-args", "found", found, "ICFIntPubTopDomainICFIntPubTopDomain");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFIntPubTopProjectHPKey ) {
			ICFIntPubTopProjectHPKey rhs = (ICFIntPubTopProjectHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setTopProject( ICFIntPubTopProject src ) {
		...
		setJustPubRequiredContainerParentSDom(src.getRequiredContainerParentSDom());
		setJustPubRequiredTenantId(src.getRequiredTenantId());
		setJustPubRequiredTopDomainId(src.getRequiredTopDomainId());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredTopDomainId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFIntPubBuffTopProject" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
