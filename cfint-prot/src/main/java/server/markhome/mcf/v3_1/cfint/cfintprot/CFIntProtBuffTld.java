// Description: Java 17 implJustProtementation of a Tld buffer
	...
	implements ICFIntProtTld, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntProtTopDomain> getOptionalComponentsTopDomain(ICFLibKeyHash256 argId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopDomain", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTopDomainTable targetTable = targetBackingCFInt.getTableTopDomain();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopDomain", 0, "ICFIntProtSchema.getBackingCFInt().getTableTopDomain()");
		}
	...
	@Override
	public ICFSecProtTenant getRequiredContainerTenant(ICFLibKeyHash256 argTenantId) {
		ICFSecProtSchema targetBackingCFSec = ICFSecProtSchema.getBackingCFSec();
		if (targetBackingCFSec == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerTenant", 0, "ICFSecProtSchema.getBackingCFSec()");
		}
		ICFSecProtTenantTable targetTable = targetBackingCFSec.getTableTenant();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerTenant", 0, "ICFSecProtSchema.getBackingCFSec().getTableTenant()");
		}
