// Description: Java 17 implJustProtementation of a TopDomain buffer
	...
	implements ICFIntProtTopDomain, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFIntProtTopProject> getOptionalComponentsTopProject(ICFLibKeyHash256 argId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopProject", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTopProjectTable targetTable = targetBackingCFInt.getTableTopProject();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTopProject", 0, "ICFIntProtSchema.getBackingCFInt().getTableTopProject()");
		}
	...
	@Override
	public List<ICFIntProtLicense> getOptionalComponentsLicense(ICFLibKeyHash256 argId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsLicense", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtLicenseTable targetTable = targetBackingCFInt.getTableLicense();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsLicense", 0, "ICFIntProtSchema.getBackingCFInt().getTableLicense()");
		}
	...
	@Override
	public ICFIntProtTld getRequiredContainerParentTld(ICFLibKeyHash256 argTldId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTld", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTldTable targetTable = targetBackingCFInt.getTableTld();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerParentTld", 0, "ICFIntProtSchema.getBackingCFInt().getTableTld()");
		}
	...
	public void setRequiredContainerParentTld(ICFLibKeyHash256 argTldId) {
		ICFIntProtSchema targetBackingCFInt = ICFIntProtSchema.getBackingCFInt();
		if (targetBackingCFInt == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerParentTld-args", 0, "ICFIntProtSchema.getBackingCFInt()");
		}
		ICFIntProtTldTable targetTable = targetBackingCFInt.getTableTld();
		if (targetTable == null) {
		...
		else if (found instanceof ICFIntProtTld) || (found instanceof ICFIntProtTld) || (found instanceof ICFIntPubTld)) {
			super.setRequiredContainerParentTld(argTldId);
		requiredTldId = argTldId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerParentTld-args", "found", found, "ICFIntProtTldICFIntProtTldICFIntPubTld");
		}
	}
